...
class App extends React.Component {
    ...
    componentWillMount(){
        ...
        //Check if there is any order in a local storage
        ...
        return(
            <div className="catch-of-the-day">
                ...
                <Order fishes={this.state.fishes} order={this.state.order}
                        params = {this.props.params} removeOrder={this.removeOrder}
                />
                <Inventory fishes={this.state.fishes} addFish={this.addFish} 
                loadSamples={this.loadSamples} updateFish={this.updateFish}
